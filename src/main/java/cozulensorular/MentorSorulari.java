...
public class MentorSorulari {
     ...
     */
      ...
      Scanner input=new Scanner(System.in);
        ...
        System.out.println("lütfen operator seçiniz /+/-/:);
        ...
        switch (opr) {
            ...
            case ':':
                ...
                break;
            default:
                System.out.println("geçersiz operator"); }
                */
     ...
     /*   Scanner input=new Scanner(System.in);
        System.out.println("üçgen için lüfen 3 ukenar uzunluğunu giriniz");
        int a=input.nextInt();
        int b=input.nextInt();
        int c=input.nextInt();
       ...
       /* Scanner input=new Scanner(System.in);
        System.out.println("please enter piece of product");
        ...
        if (card=='y'){
            if (productPiece>10){
                System.out.println("indirimli fiyat"+(price*0.8));

            }else {
                System.out.println("indirimli fiyat"+(price*0.85));
            }
            ...
            if (productPiece>10){
                ...
                System.out.println("indirimli fiyat"+(price*0.90));
            }
